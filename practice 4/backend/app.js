...
// 10 товаров согласно заданию
//let products = [
//    { id: nanoid(6), name: 'MacBook Pro', category: 'Ноутбуки', description: 'Apple M3, 16GB RAM', price: 1999.99, stock: 5, rating: 4.8, image: 'https://via.placeholder.com/200x150?text=MacBook' },
//    { id: nanoid(6), name: 'iPhone 15', category: 'Смартфоны', description: 'A16 Bionic, 128GB', price: 999.99, stock: 8, rating: 4.9, image: 'https://via.placeholder.com/200x150?text=iPhone' },
//    { id: nanoid(6), name: 'Samsung TV', category: 'ТВ', description: '4K UHD, 55"', price: 699.99, stock: 3, rating: 4.5, image: 'https://via.placeholder.com/200x150?text=TV' },
//    { id: nanoid(6), name: 'iPad Air', category: 'Планшеты', description: 'M1 chip, 64GB', price: 599.99, stock: 6, rating: 4.7, image: 'https://via.placeholder.com/200x150?text=iPad' },
//    { id: nanoid(6), name: 'Sony WH-1000XM5', category: 'Аудио', description: 'Шумоподавление', price: 399.99, stock: 10, rating: 4.9, image: 'https://via.placeholder.com/200x150?text=Sony' },
//    { id: nanoid(6), name: 'Dell XPS 15', category: 'Ноутбуки', description: 'Intel i9, 32GB RAM', price: 2199.99, stock: 2, rating: 4.6, image: 'https://via.placeholder.com/200x150?text=Dell' },
//    { id: nanoid(6), name: 'Galaxy S24', category: 'Смартфоны', description: 'Snapdragon 8 Gen 3', price: 1099.99, stock: 7, rating: 4.7, image: 'https://via.placeholder.com/200x150?text=Galaxy' },
//    { id: nanoid(6), name: 'PS5', category: 'Игры', description: 'Digital Edition', price: 499.99, stock: 0, rating: 4.9, image: 'https://via.placeholder.com/200x150?text=PS5' },
//    { id: nanoid(6), name: 'AirPods Pro', category: 'Аудио', description: '2-го поколения', price: 249.99, stock: 15, rating: 4.8, image: 'https://via.placeholder.com/200x150?text=AirPods' },
//    { id: nanoid(6), name: 'Apple Watch', category: 'Гаджеты', description: 'Series 9, GPS', price: 429.99, stock: 4, rating: 4.6, image: 'https://via.placeholder.com/200x150?text=Watch' }
//];
